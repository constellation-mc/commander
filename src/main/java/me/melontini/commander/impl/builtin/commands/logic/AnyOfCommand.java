...
public record AnyOfCommand(List<Command.Conditioned> commands, Optional<Command.Conditioned> then, boolean shortCircuit) implements Command {
    ...
    public static final MapCodec<AnyOfCommand> CODEC = RecordCodecBuilder.mapCodec(data -> data.group(
            ...
            ExtraCodecs.optional("short_circuit", Codec.BOOL, false).forGetter(AnyOfCommand::shortCircuit)

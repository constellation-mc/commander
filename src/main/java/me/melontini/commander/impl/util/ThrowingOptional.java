...
public class ThrowingOptional<T> {
    ...
    public <E extends Throwable> void ifPresentOrElse(ThrowingConsumer<? super T, E> action, ThrowingRunnable<E> emptyAction) throws E {
        if (value != null) {
            action.accept(value);
        } else {
            emptyAction.run();
    ...
    public <E extends Throwable> ThrowingOptional<T> filter(ThrowingFunction<? super T, @NotNull Boolean, E> predicate) throws E {
    ...
    public <E extends Throwable, U> ThrowingOptional<U> map(ThrowingFunction<? super T, ? extends U, E> mapper) throws E {
    ...
    public <E extends Throwable, U> ThrowingOptional<U> flatMap(ThrowingFunction<? super T, ? extends ThrowingOptional<? extends U>, E> mapper) throws E {
        Objects.requireNonNull(mapper);
        if (isEmpty()) {
            return empty();
        } else {
    ...
    public <E extends Throwable> ThrowingOptional<T> or(ThrowingSupplier<? extends ThrowingOptional<? extends T>, E> supplier) throws E {

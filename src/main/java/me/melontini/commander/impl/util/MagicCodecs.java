...
public class MagicCodecs {
    ...
    public static final Codec<LootCondition> LOOT_CONDITION = ExtraCodecs.jsonSerializerDispatch("condition", Registries.LOOT_CONDITION_TYPE.getCodec(), LootCondition::getType, JsonSerializableType::getJsonSerializer, lootContext);

...
public class ArrayAnyMatch extends AbstractFunction implements CustomInlinerFunction {
    ...
    public EvaluationValue evaluate(Expression expression, Token functionToken, EvaluationValue... par) throws EvaluationException {
        ...
        return array.stream().anyMatch(value -> runLambda(expression, value, predicate).getBooleanValue()) ? EvaluationValue.TRUE : EvaluationValue.FALSE;
    }

...
public class DynamicEventManager extends JsonCodecDataLoader<List<Subscription<?>>> implements IdentifiableResourceReloadListener {
    ...
    public DynamicEventManager() {
        super(RELOADER.identifier(), Subscription.CODEC);
    }
    ...
    @Override
    protected void apply(Map<Identifier, List<Subscription<?>>> parsed, ResourceManager manager) {
